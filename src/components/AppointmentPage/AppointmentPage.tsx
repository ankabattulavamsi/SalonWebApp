...
import { timingsData } from "../../utils/data/CustomerAppointment/TimingsData";
...
class CustomerAppointmentPage extends Component {
  ...
  render() {
	...
	const dd = timingsData.map((item) => console.log('item', item))
								...
								<Button
									...
									<Typography
										...
										sx={{
											...
											color:
												index === this.state.isActiveIdM ? "#fff" : "",
										}}>
										{item.time}
									</Typography>
								</Button>
								...
								<Button
									...
									<Box>
										<Typography
											...
											sx={{
												backgroundColor:
													index === this.state.isActiveIdA
														? "#E7A356"
														: "",
												color:
													index === this.state.isActiveIdA ? "#fff" : "",
											}}>
											{item.time}
										</Typography>
									</Box>
