      ...
      <>
        <Box className='footer-background'> 
          <Grid container justifyContent='center'
            columnSpacing={3} rowSpacing={5} sx={{p:3}}
          >
            ...
            <Grid item lg={3} md={3} sm={12} xs={12}>
              <Box sx={{mb:2}}>
                ...
                <Typography sx={{borderBottom:"5px solid #EBB273", width:'40px'}}></Typography>
              </Box>
              <Box>
                <List>
                    {services.map((item)=>{
            ...
            <Grid item lg={3} md={3} sm={12} xs={12}>
              ...
              <Box>
                ...
                <Box className={classes.infoBox}>
                  ...
                  <Typography className={classes.infoText}>
                    121 KING STREET Eddy street and Gough street, 
          ...
          <Box sx={{py:2}} >
              <Divider variant='middle' sx={{background:'#939290', opacity:0.2,mb:2}}/>
