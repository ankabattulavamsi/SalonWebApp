        ...
        return (
            <Container>
                <Grid container className={classes.feature_info_section}>
                    <Grid item lg={9} md={8} sm={12} xs={12} className={classes.feature_content_section}>
                        ...
                        <Box className={classes.feature_paraLg_section}>
                            <Typography >Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis.</Typography>
                        </Box>
                        ...
                        <Grid container>
                            {
                              featureData.map((item:any, id:number) => {
                                return(
                                  <>
                                    <Grid item lg={5} md={6} sm={6} xs={12}key={id} className={classes.feature_iconBox_section}>
                    ...
                    <Grid item lg={3} md={4} sm={12} xs={12} className={classes.feature_imageBox_section}>
